...
#include <fstream>
    ...
    {
        boost::property_tree::xml_writer_settings<std::string> settings = boost::property_tree::xml_writer_make_settings<std::string>(' ', 1u);
        boost::property_tree::write_xml(fn, pt_, std::locale(), settings);
